...
const Products = () => {
  ...
  useEffect(() => {
    const fetchCategories = async () => {
      try {
        setLoading(true);
        const response = await publicApi.get(`/categories/collection/${collectionId}`);
  ...
  useEffect(() => {
    const fetchProducts = async () => {
      ...
      try {
        setLoading(true);
        const response = await publicApi.get(`/api/products/allProducts/${selectedCategory}`);
                                ...
                                <div className={styles.propertiesCard}>
                                  <div className={styles.propertiesImg}>
                                    ...
                                    <div className={styles.socialIcon}>
                                      <a href="/login"><FontAwesomeIcon icon={faShoppingCart} /></a>
                                      <a href="/login"><FontAwesomeIcon icon={faHeart} /></a>
                                      <a href={`/product-details?id=${product.id}`}>
